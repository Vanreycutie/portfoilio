...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        'service_juywvlm',      // Replace with your EmailJS service ID
        'template_i2zqzt2',      // Replace with your EmailJS template ID
        {
          name: formData.name,
  ...
  return (
    <div className="font-mono bg-blue-400 max-w-[2000px] mx-auto sm:py-20 p-5 rounded-lg" id="contact">
